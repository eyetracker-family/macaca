...
public:
  ...
  CvMat calib_P; double calib_P_data[3][4];
	CvMat calib_K_; double calib_K_data_[3][3];
  CvMat calib_rotMatrix_; double calib_rotMatrix_data_[3][3];
  CvMat calib_transVec_; double calib_transVec_data_[4];
