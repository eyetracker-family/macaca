...
int main(int argc,char** argv)
{
	...
	{	
    	...
    	double pose_tracker1[6]={0,0,0,0,0,0};
    	htcViveTracker->getPoseMatrix(3, 0, pose_tracker1);

		tf::Quaternion rotation(pose_tracker1[0], pose_tracker1[1], pose_tracker1[2]);
		tf::Vector3 origin(-pose_tracker1[3], pose_tracker1[4], -pose_tracker1[5]);
		...
		cout<<1<<"rotation: "<<pose_tracker1[0]<<"\t"<<pose_tracker1[1]<<"\t"<<pose_tracker1[2]<<"\t"<<"translation: "<<-pose_tracker1[3]<<"\t"<<pose_tracker1[4]<<"\t"<<-pose_tracker1[5]<<endl;
